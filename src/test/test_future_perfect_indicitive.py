...
def test_future_perfect_indicative_tu_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "future_perfect", "indicative", "tu")
        == expected
    )
...
def test_future_perfect_indicative_usted_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "future_perfect", "indicative", "usted")
        == expected
    )
...
def test_future_perfect_indicative_nosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "future_perfect", "indicative", "nosotros")
        == expected
    )
...
def test_future_perfect_indicative_vosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "future_perfect", "indicative", "vosotros")
        == expected
    )
...
def test_future_perfect_indicative_ustedes_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "future_perfect", "indicative", "ustedes")
        == expected
    )
...
def test_future_perfect_indicative_yo_er():
    ...
    assert (
        Conjugator().conjugate("beber", "future_perfect", "indicative", "yo")
        == expected
    )
...
def test_future_perfect_indicative_tu_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "future_perfect", "indicative", "tu")
        == expected
    )
...
def test_future_perfect_indicative_usted_er():
    ...
    assert (
        Conjugator().conjugate("beber", "future_perfect", "indicative", "usted")
        == expected
    )
...
def test_future_perfect_indicative_nosotros_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "future_perfect", "indicative", "nosotros")
        == expected
    )
...
def test_future_perfect_indicative_vosotros_er():
    ...
    assert (
        Conjugator().conjugate("beber", "future_perfect", "indicative", "vosotros")
        == expected
    )
...
def test_future_perfect_indicative_ustedes_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "future_perfect", "indicative", "ustedes")
        == expected
    )
