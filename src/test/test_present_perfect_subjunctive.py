...
def test_present_perfect_subjunctive_yo_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "yo")
        == expected
    )
...
def test_present_perfect_subjunctive_tu_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "tu")
        == expected
    )
...
def test_present_perfect_subjunctive_usted_ar():
    expected = "haya hablado"
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "usted")
        == expected
    )
...
def test_present_perfect_subjunctive_nosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "nosotros")
        == expected
    )
...
def test_present_perfect_subjunctive_vosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "vosotros")
        == expected
    )
...
def test_present_perfect_subjunctive_ustedes_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "subjunctive", "ustedes")
        == expected
    )
...
def test_present_perfect_subjunctive_yo_er():
    ...
    assert (
        Conjugator().conjugate("beber", "present_perfect", "subjunctive", "yo")
        == expected
    )
...
def test_present_perfect_subjunctive_tu_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "subjunctive", "tu")
        == expected
    )
...
def test_present_perfect_subjunctive_usted_er():
    expected = "haya bebido"
    assert (
        Conjugator().conjugate("beber", "present_perfect", "subjunctive", "usted")
        == expected
    )
...
def test_present_perfect_subjunctive_nosotros_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "subjunctive", "nosotros")
        == expected
    )
...
def test_present_perfect_subjunctive_vosotros_er():
    ...
    assert (
        Conjugator().conjugate("beber", "present_perfect", "subjunctive", "vosotros")
        == expected
    )
...
def test_present_perfect_subjunctive_ustedes_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "subjunctive", "ustedes")
        == expected
    )
