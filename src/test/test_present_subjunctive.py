...
def test_present_subjunctive_usted_ar():
    expected = "hable"
    assert Conjugator().conjugate('hablar','present','subjunctive','usted') == expected

def test_present_subjunctive_nosotros_ar():
    expected = 'hablemos'
    assert str(Conjugator().conjugate('hablar','present','subjunctive','nosotros')) == expected

def test_present_subjunctive_vosotros_ar():
    expected = "habléis"
    assert Conjugator().conjugate('hablar','present','subjunctive','vosotros') == expected

def test_present_subjunctive_ustedes_ar():
    expected = "hablen"
    assert Conjugator().conjugate('hablar','present','subjunctive','ustedes') == expected