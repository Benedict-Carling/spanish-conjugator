...
def test_past_anterior_indicative_tu_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "past_anterior", "indicative", "tu")
        == expected
    )
...
def test_past_anterior_indicative_usted_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "past_anterior", "indicative", "usted")
        == expected
    )
...
def test_past_anterior_indicative_nosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "past_anterior", "indicative", "nosotros")
        == expected
    )
...
def test_past_anterior_indicative_vosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "past_anterior", "indicative", "vosotros")
        == expected
    )
...
def test_past_anterior_indicative_ustedes_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "past_anterior", "indicative", "ustedes")
        == expected
    )
...
def test_past_anterior_indicative_yo_er():
    ...
    assert (
        Conjugator().conjugate("beber", "past_anterior", "indicative", "yo") == expected
    )
...
def test_past_anterior_indicative_tu_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "past_anterior", "indicative", "tu") == expected
    )
...
def test_past_anterior_indicative_usted_er():
    ...
    assert (
        Conjugator().conjugate("beber", "past_anterior", "indicative", "usted")
        == expected
    )
...
def test_past_anterior_indicative_nosotros_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "past_anterior", "indicative", "nosotros")
        == expected
    )
...
def test_past_anterior_indicative_vosotros_er():
    ...
    assert (
        Conjugator().conjugate("beber", "past_anterior", "indicative", "vosotros")
        == expected
    )
...
def test_past_anterior_indicative_ustedes_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "past_anterior", "indicative", "ustedes")
        == expected
    )
