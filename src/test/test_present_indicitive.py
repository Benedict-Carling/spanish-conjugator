...
def test_present_indicative_usted_ar():
    expected = "habla"
    assert (
        Conjugator().conjugate("hablar", "present", "indicative", "usted") == expected
    )
...
def test_present_indicative_nosotros_ar():
    expected = "hablamos"
    assert (
        str(Conjugator().conjugate("hablar", "present", "indicative", "nosotros"))
        == expected
    )
...
def test_present_indicative_vosotros_ar():
    expected = "habláis"
    assert (
        Conjugator().conjugate("hablar", "present", "indicative", "vosotros")
        == expected
    )
...
def test_present_indicative_ustedes_ar():
    expected = "hablan"
    assert (
        Conjugator().conjugate("hablar", "present", "indicative", "ustedes") == expected
    )
