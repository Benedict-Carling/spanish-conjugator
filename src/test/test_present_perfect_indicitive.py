...
def test_present_perfect_indicative_tu_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "indicative", "tu")
        == expected
    )
...
def test_present_perfect_indicative_usted_ar():
    expected = "ha hablado"
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "indicative", "usted")
        == expected
    )
...
def test_present_perfect_indicative_nosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "indicative", "nosotros")
        == expected
    )
...
def test_present_perfect_indicative_vosotros_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "indicative", "vosotros")
        == expected
    )
...
def test_present_perfect_indicative_ustedes_ar():
    ...
    assert (
        Conjugator().conjugate("hablar", "present_perfect", "indicative", "ustedes")
        == expected
    )
...
def test_present_perfect_indicative_yo_er():
    expected = "he bebido"
    assert (
        Conjugator().conjugate("beber", "present_perfect", "indicative", "yo")
        == expected
    )
...
def test_present_perfect_indicative_tu_ir():
    expected = "has vivido"
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "indicative", "tu")
        == expected
    )
...
def test_present_perfect_indicative_usted_er():
    expected = "ha bebido"
    assert (
        Conjugator().conjugate("beber", "present_perfect", "indicative", "usted")
        == expected
    )
...
def test_present_perfect_indicative_nosotros_ir():
    ...
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "indicative", "nosotros")
        == expected
    )
...
def test_present_perfect_indicative_vosotros_er():
    ...
    assert (
        Conjugator().conjugate("beber", "present_perfect", "indicative", "vosotros")
        == expected
    )
...
def test_present_perfect_indicative_ustedes_ir():
    expected = "han vivido"
    assert (
        Conjugator().conjugate("vivir", "present_perfect", "indicative", "ustedes")
        == expected
    )
